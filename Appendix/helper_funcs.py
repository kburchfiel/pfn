# Helper functions that proved useful for multiple sections of
...
def config_notebook(render_for_pdf=render_for_pdf, 
    ...
    on GitHub.) Set to False to optimize outputs for interactive
    ...
    if render_for_pdf == True:
        ...
        # within PDF versions of this script than will HTML copies)
    else:
...
def wadi(fig, file_path, height=405, aspect_ratio=16/9,
    ...
    also display graphics from local files that weren't created within 
    Plotly (such as Folium maps).
