...
render_for_pdf = True # Setting this variable here makes it easier
...
def wadi(fig, file_path, height=405, aspect_ratio=16/9,
    ...
    an .html or .png file depending on the value of display_type.
...
static file path: {static_file_path}.png, display type: {display_type}")
    ...
    if display_type == 'png':
        ...
        # .html image that we just created, but this approach is simpler
        # and should also work fine in most cases.