...
The [flexible_enrollment_dashboard](https://pfndashappdemo-470317599391.us-central1.run.app/flexible_enrollment_dashboard) page has a similar setup to that of the flexible survey results dashboard except that it also utilizes the import_layout() function found in import_layout.py. This function can simplify the process of building Dash app pages' layouts.
