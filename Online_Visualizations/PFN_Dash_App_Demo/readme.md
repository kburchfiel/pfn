...
The [flexible_interactive_dashboard](https://pfndashappdemo-470317599391.us-central1.run.app/flexible_interactive_dashboard) page shows a more complex dashboard that utilizes the autopivot() and autobar() functions in auto_pivot_and_graph.py(). These two functions allow for a wide range of comparison and color options.
