...
function (stored within [import_layout.py](https://github.com/kburchfiel/pfn/blob/main/Online_Visualizations/\
...
applies the autotable() function in [auto_pivot_and_graph.py](https://github.com/kburchfiel/pfn/blob/main/Online_Visualizations/\
...
The source code for these dashboards can be found [at this link](https://github.com/kburchfiel/pfn/tree/main/\
