...
I also have substantial concerns about potential copyright infringement caused by generative AI. If a Generative API tool provided me with code that was actually protected by a 'copyrleft' license like the GPL, I might then need to release my entire project under the GPL, rather than the more 'permissive' MIT license that I selected. If it instead gave me tool that was actually covered under a proprietary license, I might then get sued for using someone else's work without his or her permission.
